...
function ShtoGrupetEProduktit(props) {
    ...
    function handleSubmit() {
        axios.post('https://localhost:7285/api/GrupiProduktit/shtoGrupinEProduktit', {
    ...
    const handleKontrolli = () => {
        if (
            ...
            if (konfirmoNjesineMatese == false && njesiteMatese.filter((item) => item.grupiIProduktit === njesiaMatese).length !== 0) {
