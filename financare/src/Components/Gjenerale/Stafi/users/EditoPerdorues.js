      ...
      <Modal.Body>
        <Form>
          <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
            ...
            <Form.Control
              value={
                ...
                perdoruesi.perdoruesi.userId +
                  " - " +
                  perdoruesi.perdoruesi.email
              }
              disabled
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
            ...
            <br />
            <ToggleButtonGroup
              className="toggleButtonGroupContainer"
              type="checkbox"
              value={roletSelektim}
                ...
                shfaqRolet.map((roli) => (
                  <ToggleButton
                    ...
                    style={getToggleButtonStyle(
                      roletSelektim.includes(roli.name)
                    )}
                    className="toggleButton" // Add the CSS class
                  >
                    {roli.name}
                  </ToggleButton>
                ))}
